...
public class FindCategoryDiscountTest {
    ...
    public void fineCategory1() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 1, input);
    ...
    public void fineCategory2() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 2, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory3() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 3, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory4() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 4, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory5() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 5, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory6() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 6, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory7() {
        ...
        List<Product> actual = FindCategoryDiscount.fineCategory(newList, 7, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    @Test(expected = UnsupportedOperationException.class)
    public void utilityClassTest() throws NoSuchMethodException, IllegalAccessException, InstantiationException {
        final Constructor<FindCategoryDiscount> constructor =
                FindCategoryDiscount.class.getDeclaredConstructor();
