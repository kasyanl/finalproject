...
public class FineProductOfCategoryTest {
    ...
    public void selectCategoryByAllList1Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 1);
    ...
    public void selectCategoryByAllList2Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 2);
        assertEquals(newList, actual);
    }
    ...
    public void selectCategoryByAllList3Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 3);
        assertEquals(newList, actual);
    }
    ...
    public void selectCategoryByAllList4Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 4);
        assertEquals(newList, actual);
    }
    ...
    public void selectCategoryByAllList5Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 5);
        assertEquals(newList, actual);
    }
    ...
    public void selectCategoryByAllList6Category() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 6);
        assertEquals(newList, actual);
    }
    ...
    public void selectCategoryByAllListNoneCategory() {
        ...
        List<Product> actual = FineProductOfCategory.selectCategoryByAllList(newList, 9);
        assertEquals(newList, actual);
    }
    @Test(expected = UnsupportedOperationException.class)
    public void utilityClassTest() throws NoSuchMethodException, IllegalAccessException, InstantiationException {
        final Constructor<FineProductOfCategory> constructor =
                FineProductOfCategory.class.getDeclaredConstructor();
