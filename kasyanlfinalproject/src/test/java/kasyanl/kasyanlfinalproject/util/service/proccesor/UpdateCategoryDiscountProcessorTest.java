...
public class UpdateCategoryDiscountProcessorTest {
    ...
    public void fineCategory1() {
        ...
        List<Product> actual = UpdateCategoryDiscountProcessor.fineCategory(newList, 1, input);
    ...
    public void fineCategory2() {
        ...
        List<Product> actual = UpdateCategoryDiscountProcessor.fineCategory(newList, 2, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory3() {
        ...
        List<Product> actual = UpdateCategoryDiscountProcessor.fineCategory(newList, 3, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory4() {
        ...
        List<Product> actual = UpdateCategoryDiscountProcessor.fineCategory(newList, 4, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
    ...
    public void fineCategory5() {
        ...
        List<Product> actual = UpdateCategoryDiscountProcessor.fineCategory(newList, 5, input);
        assertEquals(expected.equals(actual), actual.equals(expected));
    }
